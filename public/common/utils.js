define(["require", "exports"], function (require, exports) {
    ...
    exports.calculateTimeSeries1 = exports.calculateTimeSeries = void 0;
    ...
    exports.calculateTimeSeries = calculateTimeSeries;
    const calculateTimeSeries1 = ({ years, mu, sigma, fee, initialSum, monthlySum }) => {
        var series = [];
        for (let k = 0; k <= 12 * years; ++k) {
            series.push(mapDate({ t: k / 12, mu, sigma, fee, initialSum, monthlySum }));
        }
    ...
    exports.calculateTimeSeries1 = calculateTimeSeries1;
});
